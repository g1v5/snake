function C(level, svgObject) {
	...
	$(this.svgObject).mousedown(this.onTouchStart.bind(this));
...
C.prototype.ask = function(x, y, txt, callBack) {
	...
	var button = "<button id=\"ab\" type=\"button\" style=\"position:fixed;left:" + (x + 10).toString() + ";top:" + (y + 10).toString() +";widht:300;height:20;z-index:9999\">OK</button>"
	
	var button2 = "<button id=\"cb\" type=\"button\" style=\"position:fixed;left:" + (x + 80).toString() + ";top:" + (y + 10).toString() +";widht:300;height:20;z-index:9999\">Cancel</button>"
...
C.prototype.askText = function(x, y, width, height, txt, callBack) {
	...
	var button = "<button id=\"ab\" type=\"button\" style=\"position:fixed;left:" + (x + 10).toString() + ";top:" + (y + 20 + height*10).toString() +";widht:300;height:20;z-index:9999\">OK</button>"

	var button2 = "<button id=\"cb\" type=\"button\" style=\"position:fixed;left:" + (x + 80).toString() + ";top:" + (y + 20 + height*10).toString() +";widht:300;height:20;z-index:9999\">Cancel</button>"
				...
				if(widthRec.toString() != "NaN") {
					...
					if((x > xRec && x < (xRec + widthRec)) && (y > yRec && y < (yRec + heightRec))) {
						...
						try {
							...
							this.droppedOn(this.level.levelUpdateArray[i]);
